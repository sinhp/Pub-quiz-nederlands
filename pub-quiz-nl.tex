...
\begin{frame}[standout]
 \begin{center}
\includemedia[
        addresource=countdown.mp3,
        transparent,
        flashvars={
            source=countdown.mp3
            &autoPlay=true
        },
]{\includegraphics[scale=0.25]{halloween.jpg}}{APlayer.swf}
\end{center}
\end{frame}
...
\setcounter{preframevnum}{\value{vnum}}
\begin{frame}[fragile]{\vnummer \small \hfill (\textsc{10 punten voor elk})}
\setcounter{vnum}{\value{preframevnum}}
\pause
...
\metroset{block=fill}
 \begin{alertblock}{Vraag}
   ...
   \pause
   \vspace{10pt}
   \texttt{bijv. Stel dat er twee teams zijn: team Gandalf en team Saruman. Als team Saruman 60 punten verzamelt voorafgaand aan deze vraag, en team Gandalf schat dat Saruman 50 punten verzamelde voorafgaand aan deze vraag, dan verzamelt Gandalf extra 7 punten.} \\
   \vspace{10pt}
   \emph{Vergeet niet dat het maximaal mogelijke aantal punten is ??}
 \end{alertblock}
\end{frame}
...
\vspace{5pt}
{\color{utrechtBlue}{\texttt{\scriptsize aanvullende uitleg:}}} \scriptsize{Met kleine potjes zijn hier kinderen bedoeld. Maar echte potjes (bloempotjes) hebben net als kinderen oren. Het wordt oren heeft in dit spreekwoord dus twee betekenisses: gehoororgan en handvatje.} }
\pause 
\column{0.45\textwidth}
