...
\begin{frame}[fragile]{Vraag 1 (\textsc{10punten})}
\metroset{block=fill}
...
\vspace{10pt}
 ...
 \begin{figure}
     \centering
     \grabto{https://commons.wikimedia.org/wiki/File:WOF_Boudewijn_de_Groot.jpg}{WOF_Boudewijn_de_Groot.jpg}
     \includegraphics{WOF_Boudewijn_de_Groot.jpg}
     \caption{zijn/haar handafdrukken in de Walk of Fame te Rotterdam}
     \label{fig:my_label}
 \end{figure}
 \end{exampleblock}
\end{frame}
